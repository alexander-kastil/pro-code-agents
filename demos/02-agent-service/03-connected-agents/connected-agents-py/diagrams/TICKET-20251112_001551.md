...
Here's the triage for the ticket regarding users being unable to reset their password from the mobile app:

- **Priority**: **High** - This is a user-facing and blocking issue that affects the essential functionality of password resets .
  
- **Assigned Team**: **Backend** - The issue likely involves server-side logic and falls under the backend team's responsibilities .
  
- **Effort Level**: **Medium** - It may require around 2-3 days of work to investigate, debug, and implement a fix, including thorough testing across different devices .
