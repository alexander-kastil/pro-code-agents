# Ticket 20251116_154826

## Ticket Description
- **Description**: Users can't reset their password from the mobile app.
- **Resolution**: 1. **Priority:** High - Password reset issues can prevent users from accessing their accounts, impacting user experience and security.
2. **Team:** Backend - The functionality for password resets typically involves backend processes and user authentication.
3. **Effort Required:** Medium - This issue may require investigation into the backend systems, updates to the API for password resets, and testing to ensure functionality works properly.
