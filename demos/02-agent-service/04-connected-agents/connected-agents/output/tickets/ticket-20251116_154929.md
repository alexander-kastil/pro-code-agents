# Ticket 20251116_154929

## Ticket Description
- **Description**: Users can't reset their password from the mobile app.
- **Resolution**: 1. **Priority:** High - This issue affects user accessibility and security, making it a critical concern.
2. **Team:** Backend - The password reset function typically involves server-side logic and user authentication processes.
3. **Effort Required:** Medium - It may require debugging and testing to ensure the feature works correctly across all devices.
