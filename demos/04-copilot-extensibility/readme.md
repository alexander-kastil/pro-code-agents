# Module 3: Microsoft Copilot Pro-Code Extensibility
...
## Integrate Azure AI Foundry Agents using Microsoft Agent SDK

- Overview of Azure AI Foundry Agents
- Setting up Azure AI Foundry Agents
- Integrating Azure AI Foundry Agents with Microsoft Agent SDK

## Custom Engine Agents using the Teams AI Library

- Introduction & Benefits of using Teams AI Library
- Teams CLI & Scaffolding
