...
![Screenshot of the App registrations](./_images/02-05-azure-ad-portal-home.png)

On the **App registrations** page, select **New registration**.

![Screenshot of App Registrations page](./_images/02-05-azure-ad-portal-new-app-00.png)
...
- **Supported account types**: Accounts in this organizational directory only (Contoso only - Single tenant)
  ...
  ![Screenshot of the Register an application page](./_images/02-05-azure-ad-portal-new-app-01.png)
...
![Screenshot of the application ID of the new app registration](./_images/02-05-azure-ad-portal-new-app-details.png)
...
![Screenshot of the Platform configurations section](./_images/02-05-azure-ad-portal-new-app-02.png)
...
![Screenshot of the Configure Desktop + devices panel](./_images/02-05-azure-ad-portal-new-app-03.png)

In the **Authentication** panel, scroll down to the **Allow public client flows** section and set the toggle to **Yes**.

![Screenshot of the Allow public client flows section](./_images/02-05-azure-ad-portal-new-app-04.png)
...
![Screenshot of the API Permissions navigation item](./_images/02-05-azure-ad-portal-new-app-permissions-01.png)

Select the **Add a permission** button.

In the **Request API permissions** panel that appears, select **Microsoft Graph** from the **Microsoft APIs** tab.

![Screenshot of Microsoft Graph in the Request API permissions panel](./_images/02-05-azure-ad-portal-new-app-permissions-02.png)
...
![Screenshot of the Files.Read permission in the Request API permissions panel](./_images/02-05-03-azure-ad-portal-new-app-permissions-03.png)
...
![Screenshot of the console application showing all files in the currently signed-in user's OneDrive root folder](./_images/02-05-03-app-run-01.png)
...
![Screenshot of the console application showing a specific file from the user's OneDrive](./_images/02-05-03-app-run-02.png)
...
![Screenshot of the console application showing the saved file from the user's OneDrive](./_images/02-05-03-app-run-03.png)
