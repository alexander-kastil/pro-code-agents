...
public class MusicLibraryPlugin
{
    ...
    public static string GetRecentPlays()
    {
        ...
        string content = File.ReadAllText($"{dir}/data/recently-played.txt");
        return content;
    }
    ...
    {
        string dir = Directory.GetCurrentDirectory();
        string content = File.ReadAllText($"{dir}/data/music-library.txt");
        return content;
    }
        ...
        [Description("The song genre")] string genre)
    {
        ...
        string filePath = "data/recently-played.txt";
